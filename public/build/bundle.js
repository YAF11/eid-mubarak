...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	document.title = title_value = "\n    Happy Eid Mubarak " + /*year*/ ctx[3] + "H | Yafi' Irsyad Ramadhan\n  ";
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			p0 = element("p");
    			p0.textContent = `Selamat Idul Fitri ${/*year*/ ctx[3]} H`;
    			t9 = space();
    			p1 = element("p");
    			t10 = text("Taqabbalallahu Minna Wa Minkum");
    			t11 = space();
    			span = element("span");
    			t12 = text("🤝");
    			t13 = space();
    			p2 = element("p");
    			p2.textContent = "Klik untuk bersalaman";
    			t15 = space();
    			footer = element("footer");
    			p3 = element("p");
    			p3.textContent = `${/*date*/ ctx[2].getFullYear()} | Yafi' Irsyad Ramadhan`;
    			attr_dev(link, "rel", "stylesheet");
    			attr_dev(link, "href", "https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css");
    			add_location(link, file, 30, 2, 505);
    			...
    			add_location(script, file, 34, 2, 623);
    			attr_dev(h1, "class", "svelte-16jrag0");
    			add_location(h1, file, 44, 4, 882);
    			attr_dev(h2, "class", "svelte-16jrag0");
    			add_location(h2, file, 45, 4, 908);
    			attr_dev(p0, "class", "svelte-16jrag0");
    			add_location(p0, file, 46, 4, 936);

    			attr_dev(p1, "class", p1_class_value = "" + (null_to_empty(/*maaf*/ ctx[1]
    			? "maaf animate__animated animate__heartBeat"
    			: "maaf") + " svelte-16jrag0"));

    			add_location(p1, file, 47, 4, 975);

    			attr_dev(span, "class", span_class_value = "" + (null_to_empty(/*shake*/ ctx[0]
    			? "salam animate__animated animate__shakeY"
    			: "salam") + " svelte-16jrag0"));

    			add_location(span, file, 51, 4, 1158);
    			attr_dev(p2, "class", "salam-teks svelte-16jrag0");
    			add_location(p2, file, 57, 4, 1355);
    			attr_dev(div, "class", "animate__animated animate__fadeIn svelte-16jrag0");
    			add_location(div, file, 43, 2, 830);
    			attr_dev(p3, "class", "svelte-16jrag0");
    			add_location(p3, file, 60, 4, 1451);
    			attr_dev(footer, "class", "svelte-16jrag0");
    			add_location(footer, file, 59, 2, 1438);
    			attr_dev(main, "class", "svelte-16jrag0");
    			add_location(main, file, 42, 0, 821);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span, "click", /*showConfetti*/ ctx[4], false, false, false),
    					listen_dev(p2, "click", /*showConfetti*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*maaf*/ 2 && p1_class_value !== (p1_class_value = "" + (null_to_empty(/*maaf*/ ctx[1]
    			? "maaf animate__animated animate__heartBeat"
    			: "maaf") + " svelte-16jrag0"))) {
